...
public class CarServiceTest {
    ...
    public void isDuplicatedPlate_withDuplicatedResult() {
        ...
        when(carRepository.findByCriteria("plate",car.getPlate()))
                .thenReturn(Optional.of(dbCar));
    ...
    @Test
    public void remove_removeCarExist(){
        Car car = buildCar();
        ...
        verify(carRepository, times(1)).remove(car);
    }
